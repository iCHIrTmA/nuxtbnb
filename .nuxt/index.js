...
import nuxt_plugin_plugin_42f5205a from 'nuxt_plugin_plugin_42f5205a' // Source: ./components/plugin.js (mode: 'all')
import nuxt_plugin_pluginclient_66922e23 from 'nuxt_plugin_pluginclient_66922e23' // Source: ./cloudinary/plugin.client.js (mode: 'client')
import nuxt_plugin_pluginserver_6768c0aa from 'nuxt_plugin_pluginserver_6768c0aa' // Source: ./cloudinary/plugin.server.js (mode: 'server')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_42f5205a === 'function') {
    await nuxt_plugin_plugin_42f5205a(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_66922e23 === 'function') {
    await nuxt_plugin_pluginclient_66922e23(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_pluginserver_6768c0aa === 'function') {
    await nuxt_plugin_pluginserver_6768c0aa(app.context, inject)
  }
