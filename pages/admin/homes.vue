<template>
    <div>[LIST oF HOMES HERE]
        <h2 class="text-xl bol">Add a home</h2>
        <form class="form" @submit.prevent="onSubmit">
            ...
            City: <input type="text" v-model="home.location.city" class="w-60"/><br/>
            State: <input type="text" v-model="home.location.state" class="w-60"/><br/>
            Postal Code: <input type="text" v-model="home.location.postalCode" class="w-60"/><br/>
            Country: <input type="text" v-model="home.location.country" class="w-60"/><br/>
...
export default {
    ...
    methods: {
        imageUpdated(imgUrl, index) {
            this.home.images[index] = imgUrl
        },
        changed(event) {
